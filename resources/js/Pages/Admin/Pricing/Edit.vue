                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex items-center justify-end gap-4">
                                ...
                                <button type="submit" 
                                    ...
                                    {{ form.processing ? 'Updating...' : 'Update Pricing Plan' }}
                                </button>
                            </div>
                        </form>
                    </div>
...
const form = useForm({
    title: props.pricing.title,
    subtitle: props.pricing.subtitle,
    price: props.pricing.price,
    period: props.pricing.period,
    description: props.pricing.description,
    features: props.pricing.features || [''],
    button_text: props.pricing.button_text,
    button_url: props.pricing.button_url,
    recommended: props.pricing.recommended,
    active: props.pricing.active,
    order: props.pricing.order,
});
...
const submit = () => {
    ...
    form.put(route('admin.pricing.update', props.pricing.id));
};
</script>
